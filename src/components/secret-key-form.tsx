	...
	return (
		<form className="mx-auto mt-10 max-w-[640px]">
			...
			<div className="flex gap-5">
				<div className="flex-1 rounded-lg bg-[hsl(240,5%,34%)] p-2">
					<input
						id="secret-key"
						className="bg-secondary-surface w-full rounded-md border-2 border-[hsl(240,4%,39%)] px-4 py-2 text-base placeholder:text-[hsl(219_8%_60%)] focus:border-[hsl(240,4%,46%)] focus:outline-none"
						type="text"
						placeholder="Digite su increible clave secreta"
						required
					/>
				</div>
				<div className="bg-funny-gradient flex-1 rounded-lg p-2">
					<button
